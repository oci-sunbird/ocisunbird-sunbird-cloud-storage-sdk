...
import org.sunbird.cloud.storage.service.{AzureStorageService, S3StorageService, CephS3StorageService, GcloudStorageService,OCIS3StorageService}

case class StorageConfig(`type`: String, storageKey: String, storageSecret: String, endPoint: Option[String] = None,region: String = "")
